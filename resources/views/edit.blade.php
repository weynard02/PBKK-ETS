<x-app-layout>
    ...
    <div class="py-12">
        <div class="container mx-auto px-4">
            ...
            <form action="/edit/{{$barang->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
